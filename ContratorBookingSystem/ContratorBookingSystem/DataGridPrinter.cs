...
namespace ContratorBookingSystem
{
	...
	public class DataGridPrinter
	{
		...
		public void DrawHeader(Graphics g)
		{
            ...
            int columnwidth = 92;// PageWidth/TheTable.Columns.Count;
		...
		public bool DrawRows(Graphics g)
		{
			...
			try
			{
				...
				cellformat.Trimming = StringTrimming.EllipsisCharacter;
				cellformat.FormatFlags = StringFormatFlags.NoWrap | StringFormatFlags.LineLimit;
                int columnwidth = 92;// (PageWidth-92)/TheTable.Columns.Count;
                ...
                for (int i = initialRowCount; i < TheTable.Rows.Count; i++)
				{
                    ...
                    if(PageNumber == 1 ?  rowCountEachPage >= 25 : rowCountEachPage >= 30)
					{
